...
class CalendarServiceTest extends Specification {
    ...
    def "test roundIso at forward #forward with #iso to #output"() {
        when:
        String result = subject.roundIso(iso, 'GMT', minutes, forward)

        then:
        result == output

        where:
        iso                             | forward   | minutes   || output
        // 30-minute intervals
        '2023-01-14T08:15:00.000+0000'  | false     | 30        || '2023-01-14T08:30:00.000+0000'
        '2023-01-14T08:45:00.000+0000'  | false     | 30        || '2023-01-14T08:30:00.000+0000'
        '2023-01-14T16:00:00.000+0000'  | false     | 30        || '2023-01-14T16:00:00.000+0000'
        '2023-01-15T08:45:00.000+0000'  | true      | 30        || '2023-01-15T09:00:00.000+0000'
        '2023-01-15T23:45:00.000+0000'  | true      | 30        || '2023-01-16T00:00:00.000+0000'
        // 20-minute intervals
        '2023-01-14T08:15:00.000+0000'  | false     | 20        || '2023-01-14T08:20:00.000+0000'
        '2023-01-14T08:45:00.000+0000'  | false     | 20        || '2023-01-14T08:40:00.000+0000'
        '2023-01-14T16:00:00.000+0000'  | false     | 20        || '2023-01-14T16:00:00.000+0000'
        '2023-01-15T08:45:00.000+0000'  | true      | 20        || '2023-01-15T09:00:00.000+0000'
        '2023-01-15T23:45:00.000+0000'  | true      | 20        || '2023-01-16T00:00:00.000+0000'
