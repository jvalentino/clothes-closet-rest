...
class AppointmentController {
    ...
    ResultDto updateContacted(@PathVariable('appointmentId') Long appointmentId,
                              @PathVariable('contacted') Boolean contacted) {
        appointmentService.markContacted(appointmentId, contacted)
        new ResultDto()
    }
